  ...
  <div class="container ">
    <div class="row">
      <div class="col-md-4 text-center">
        <h5 class="text-light"><b>Social Media</b></h5>
      ...
      <div class="col-md-4">
        <h5 class="text-light"><b>Important Links</b></h5>
        <ul class="list-unstyled">
          <li><a href="#" id="ni" class="text-light">Terms & Conditions</a></li>
          <li><a href="#" id="ni" class="text-light">Privacy Policy</a></li>
          <li><a href="#" id="ni" class="text-light">Help</a></li>
          <li><a href="#" id="ni" class="text-light">Contact us</a></li>
        </ul>
      </div>
      <div class="col-md-4" itemscope itemtype="http://schema.org/business">
        <h5 itemprop="name" class="text-light"><b>For Enquiries</b></h5>
        <ul class="list-unstyled">
          <li><i class="fa fa-envelope"></i>&emsp;<a href="mailto:yourmail@gmail.com" class="text-light" id="ni" itemprop="email">yourmail@domain.com</a></li>
          <li><i class="fa fa-phone"></i>&emsp;<a href="tel:+919876543210" class="text-light" id="ni" itemprop="telephone">+91 9876543210</a></li>
        </ul>
      </div>
    </div>
  </div>
  <div class="footer-copyright footer-dark text-center" style="background-color:rgb(50, 90, 150);color:white;">© <a href="#" id="ni" class="text-light text-decoration-none">QueryPup</a> <?php echo (date('Y') - 1) ?>-<?php echo date('Y') ?>
  </div>
</footer>
<!-- Footer pc ends-->
<!-- Footer mobile start -->
<footer class="footer text-center" id="footer2" style="background:black;color:snow;">
  <ul class="list-inline">
    ...
    <li class="list-inline-item"><a href="https://wa.me/919876543210" class="text-success" target="_blank"><img src="../assets/whatsapp-square.png" alt="w" width="15" height="15" style="background:white;"></a></li>
  </ul>
